            ...
            case 0: // Just does the code like it used to, as there are 50/50 ball and strike options
                ...
                if (i <= 50) //use balls
                {
                   // print("1");
                    ...
                    endPoses = Balls[temp];
                    Debug.LogError($"this is end point {endPoses} of AverageButton " + "Ball");
                ...
                else //use Strikes
                {
                  //  print("1");
                    ...
                    Debug.LogError($"this is end point {endPoses} of AverageButton " + "Strike");
                }
                break;
            ...
            case 2:
                ...
                if (x <= 95) // use balls
                {
                   // print("2");
                    int temp = Random.Range(0, Strikes.Count);
                    endPoses = Strikes[temp];
                    Debug.LogError($"this is end point {endPoses} of PinPointButton " + "Ball");
                }
                else //use Strikes
                {
                   // print("2");
                    int temp = Random.Range(0, Balls.Count);
                    endPoses = Balls[temp];
                    Debug.LogError($"this is end point {endPoses} of PinPointButton " + "Strike");
                }
                break;
        }
